  ...
  protected calculateVectors(
    ...
    if (
      ...
      if (options.calculateDiscontinuityVectors || !state.isDiscontinuity) {
        ...
        // If the leg starts in a discontinuity and we are forced to build great-circle paths through discontinuities,
        // then build a great-circle path connecting the start of the leg to the terminator. Otherwise, build a
        // direct-to path.
