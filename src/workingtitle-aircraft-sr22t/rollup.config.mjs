...
export default [
  {
    ...
    output: {
      file: 'dist/workingtitle-aircraft-sr22t/SimObjects/Airplanes/Asobo_SR22/common/panel/Instruments/G1000/Plugins/SR22TPfdPlugins.js',
      format: 'iife',
      name: 'sr22tPfd',
      globals: {
  ...
  },
  {
    input: 'build/Plugins/PFD/index.js',
    output: {
      file: 'dist/workingtitle-aircraft-sr22t/SimObjects/Airplanes/Asobo_SR22/common/panel/Instruments/G1000/Plugins/SR22TMfdPlugins.js',
      format: 'iife',
      name: 'sr22tMfd',
      globals: {
        '@microsoft/msfs-sdk': 'msfssdk',
