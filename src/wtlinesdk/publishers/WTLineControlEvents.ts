...
import { ApproachDetails } from '../fms/WTLineFmsTypes';
...
export interface WTLineControlEvents {
...
export class WTLineControlPublisher extends BasePublisher<WTLineControlEvents> {
  /**
   ...
   */
  public publishEvent<K extends keyof WTLineControlEvents>(event: K, value: WTLineControlEvents[K]): void {
