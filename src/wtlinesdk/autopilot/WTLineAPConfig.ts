import {
  Accessible, APAltCapDirector, APAltDirector, APConfig, APConfigDirectorEntry, APFLCDirector, APGPDirector, APGpsSteerDirector, APGpsSteerDirectorSteerCommand,
  APGSDirector, APHdgDirector, APLateralModes, APLvlDirector, APPitchDirector, APRollDirector, APTogaPitchDirector, APValues, APVerticalModes,
  APVNavPathDirector, APVSDirector, EventBus, FlightPlanner, MathUtils, PlaneDirector, SimVarValueType, SmoothingPathCalculator
} from '@microsoft/msfs-sdk';

// import { WTLineAPUtils } from './WTLineAPUtils';
// import { WT21VNavManager } from '../navigation/WTLineVNavManager';

// import { MessageService, WT21FmsUtils } from '@microsoft/msfs-wt21-shared';

//import { WT21NavToNavManager } from './WT21NavToNavManager';
//import { WT21VariableBankManager } from './WT21VariableBankManager';

/**
 * A WT Line autopilot configuration.
 */
export class WTLineAPConfig implements APConfig {
  ...
  //   return new APNavDirector(this.bus, apValues, APLateralModes.VOR, { lateralInterceptCurve: WTLineAPUtils.navInterceptCurve });
  // }
  ...
  //   return new APNavDirector(this.bus, apValues, APLateralModes.LOC, { lateralInterceptCurve: WTLineAPUtils.navInterceptCurve });
  // }
  ...
  //     lateralInterceptCurve: (distanceToSource: number, deflection: number, xtk: number, tas: number) =>
  // WTLineAPUtils.localizerInterceptCurve(deflection, xtk, tas)
  //   });
  // }
