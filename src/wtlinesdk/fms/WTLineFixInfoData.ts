...
export interface WTLineFixInfoCalculatedData {
 ...
 */
export interface WTLineFixInfoMarker {
...
export interface WTLineFixInfoWaypoint {
 ...
 */
export interface WTLineFixInfoFlightPlanData {
  /**
 ...
 * **For fix info internal use only!**
 */
export interface WTLineFixInfoData extends WTLineFixInfoFlightPlanData {
  /** The reference fix for the page. */
  fix: Facility | null,
  /** Ident of the fix */
  fixIdent: string | null,
