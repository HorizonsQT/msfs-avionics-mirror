...
import { WTLineLNavDataEvents } from '../../autopilot/WTLineLNavDataEvents';
...
export class GpsSource<T extends readonly string[]> extends NavSourceBase<T> {
  ...
  private readonly advisoryVnavSetting = WTLineNavigationUserSettings.getManager(this.bus).getSetting('advisoryVnavEnabled');
  ...
  public constructor(
    ...
    const lnav = this.bus.getSubscriber<LNavEvents & WTLineLNavDataEvents>();
