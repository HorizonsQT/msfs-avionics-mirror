import {
  AdcEvents, ClockEvents, ConsumerSubject, EventBus, GameStateProvider, GeoPoint, GNSSEvents, SimVarValueType, Subject,
  Subscription, UnitType,
} from '@microsoft/msfs-sdk';

import { WTLineNavigationUserSettings } from '@microsoft/msfs-wtlinesdk';
...
export class FmsPos {
  ...
  constructor(private readonly bus: EventBus,
    ...
    const fmsPosSetting = WTLineNavigationUserSettings.getManager(this.bus).getSetting('lastFmsPos');
